...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="row">
            @if ($table_header_l->isNotEmpty() || $table_header_r->isNotEmpty())
                <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($header->type == 'char' || $header->type == 'string')
                                                            @if ($table_primary->field == $header->field)
                                                                <br>
                                                                <span for="example-text-input" style="margin: 10px;"
                                                                    class="form-control-label">{{ decrypt($idencrypt) }}</span>
                                                            @endif
                                                            <input class="form-control {{ $header->class }}"
                                                                {{ $table_primary->field == $header->field ? ' key=true type=hidden' : ' type=text' }}
                                                        ...
                                                        @elseif ($header->type == 'email')
                                                            ...
                                                            @endif
                                                            <input class="form-control {{ $header->class }}"
                                                                {{ $table_primary->field == $header->field ? ' key=true type=hidden' : ' type=email' }}
                                                                value="{{ $list ? $list->{$header->field} : old($header->field) }}"
                                                                name="{{ $header->field }}"
                                                                maxlength="{{ $header->length }}">
                                                            @if ($header->note != '')
                                                        ...
                                                        @elseif ($header->type == 'text')
                                                            <textarea class="form-control {{ $header->class }}" name="{{ $header->field }}" maxlength="{{ $header->length }}">{{ $list ? $list->{$header->field} : old($header->field) }}</textarea>
                                                            @if ($header->note != '')
                                                                <p class='text-secondary text-xs pt-1 px-1'>
                                                                    {{ '*) ' . $header->note }}
                                                                </p>
                                                        ...
                                                        @elseif ($header->type == 'number')
                                                            ...
                                                            @endif
                                                            <input class="form-control {{ $header->class }}"
                                                                {{ $table_primary->field == $header->field ? ' key=true type=hidden' : ' type=number' }}
                                                                value="{{ $list ? $list->{$header->field} : old($header->field) }}"
                                                        ...
                                                        @elseif ($header->type == 'password')
                                                            <div class="flex flex-col mb-2 input-group pass">
                                                                <input class="form-control {{ $header->class }}"
                                                                    {{ $table_primary->field == $header->field ? ' key=true type=hidden' : ($header->filter == '1' ? ' type=password' : ' type=hidden') }}
                                                                    value="{{ $list ? '' : $header->default }}"
                                                                    name="{{ $header->field }}"
                                                                    max="{{ $header->length }}">
                                                                <span class="input-group-text" id="button-addon"
                                                                    style="border-color:#d2d6da;"><i
                                                        ...
                                                        @elseif ($header->type == 'date')
                                                            ...
                                                            @endif
                                                            <input class="form-control {{ $header->class }}"
                                                                {{ $table_primary->field == $header->field ? ' key=true type=hidden' : ' type=date' }}
                                                                value="{{ $list ? $list->{$header->field} : old($header->field) }}"
                                                                name="{{ $header->field }}">
                                                            @if ($header->note != '')
                                                                <p class='text-secondary text-xs pt-1 px-1'>
                                                        ...
                                                        @elseif ($header->type == 'search')
                                                                                        ...
                                                                                        @foreach ($table_result as $modal_d)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td width="20px"><span
                                                                                                        ...
                                                                                                        onclick="select_modal{{ $header->field }}('{{ $modal_d->{$field[0]} }}')"><i
                                                            ...
                                                            <script>
                                                                ...
                                                                function select_modal{{ $header->field }}(id, name) {
                                                        ...
                                                        @elseif ($header->type == 'enum')
                                                            @if ($table_primary->field == $header->field)
                                                                ...
                                                                <span for="example-text-input" style="margin: 10px;"
                                                                    class="form-control-label">{{ decrypt($idencrypt) }}</span>
                                                            @elseif ($table_primary->generateid == $header->field)
                                                                <br>
                                                                <span for="example-text-input" style="margin: 10px;"
                                                                    class="form-control-label">{{ $list->{$header->field} }}</span>
                                                            @elseif ($header->class == 'readonly')
                                                                <br>
                                                                <span for="example-text-input" style="margin: 10px;"
                                                                    class="form-control-label">{{ $list->{$header->field} }}</span>
                                                            @endif
                                                            <select class="form-select {{ $header->class }}"
                                                                ...
                                                                {{ $table_primary->field == $header->field ? ' key=true style=display:none' : ($table_primary->generateid == $header->field ? ' style=display:none' : ($header->class == 'readonly' ? ' style=display:none' : '')) }}>
                                                                <option value=""></option>
                                                                @if ($header->query != '')
                                                                    @php
                                            ...
                                            @foreach ($table_header_r as $header)
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        @elseif ($header->type == 'file')
                                                            <input class="form-control {{ $header->class }}"
                                                                type="file" id="{{ $header->field }}edit"
                                                                value="{{ $list ? $list->{$header->field} : old($header->field) }}"
                                                                name="{{ $header->field }}">
                                                            <p class='text-info text-xs pt-1 px-1 mb-1'>
                                                                {{ $list ? $list->{$header->field} : old($header->field) }}
                                                        ...
                                                        @elseif ($header->type == 'text')
                                                            <textarea class="form-control {{ $header->class }}" name="{{ $header->field }}"
                                                                maxlength="{{ $header->length }}">{{ $list ? $list->{$header->field} : old($header->field) }}</textarea>
                                                            @if ($header->note != '')
                                                                <p class='text-secondary text-xs pt-1 px-1'>
                                                                    {{ '*) ' . $header->note }}
                                                                </p>
                                                        ...
                                                        @elseif ($header->type == 'hidden')
                                                            <input class="form-control {{ $header->class }}"
                                                                type="hidden" value="{{ $header->default }}"
                                                                name="{{ $header->field }}"
                                                                max="{{ $header->length }}">
                                                            {{-- field type search --}}
                                                        @elseif ($header->type == 'search')
