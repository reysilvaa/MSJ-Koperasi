                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($header->type == 'char' || $header->type == 'string')
                                                            <input
                                                                class="form-control {{ $header->primary == '1' || $header->class == 'readonly' ? ' bg-dark text-light' : '' }} {{ $header->class }}"
                                                                type="text" disabled
                                                                {{ $table_primary->field == $header->field ? ' key=true' : ($header->class == 'readonly' ? ' key=true' : '') }}
                                                        ...
                                                        @elseif ($header->type == 'search')
                                                            <div class="flex flex-col mb-2 input-group">
                                                                <input type="text" disabled
                                                                    ...
                                                                    value="{{ $list ? $list->{$header->field} : old($header->field) }}">
                                                                <span
                                                                    class="input-group-text bg-primary text-light icon-modal-search"
                                                        ...
                                                        @elseif ($header->type == 'file')
                                                            <input class="form-control {{ $header->class }}"
                                                                type="file" disabled id="{{ $header->field }}edit"
                                                                value="{{ $list ? $list->{$header->field} : old($header->field) }}"
                                                                name="{{ $header->field }}">
                                                        ...
                                                        @elseif ($header->type == 'enum')
                                                            <select
                                                                class="form-select {{ $header->primary == '1' || $header->class == 'readonly' ? ' bg-dark text-light' : '' }} {{ $header->class }}"
                                                                {{ Str::contains($header->class, 'select-multiple') ? 'multiple' : '' }}
                                                                name="{{ $header->field }}{{ Str::contains($header->class, 'select-multiple') ? '[]' : '' }}"
                                                                disabled
                                                                {{ $table_primary->field == $header->field || $table_primary->generateid == $header->field ? ' key=true' : ($header->class == 'readonly' ? ' key=true' : '') }}>
                                                                <option value=""></option>
                                                                @if ($header->query != '')
                                                                    @php
