                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($header->type != 'hidden')
                                                            <label for="example-text-input" class="form-control-label"
                                                                {{ $table_primary->field == $header->field ? ($table_primary->generateid != '' ? ' style=display:none;' : '') : '' }}>{{ $header->alias }}</label>
                                                        @endif
                                                        {{-- field type char and string --}}
                                                        @if ($header->type == 'char' || $header->type == 'string')
                                                            <input class="form-control {{ $header->class }}"
                                                                {{ $table_primary->field == $header->field ? ($table_primary->generateid != '' ? ' key=true type=hidden' : ' type=text') : ' type=text' }}
                                                        ...
                                                        @elseif ($header->type == 'email')
                                                            <input class="form-control {{ $header->class }}" type="email"
                                                                value="{{ old($header->field) ? old($header->field) : $header->default }}"
                                                                name="{{ $header->field }}"
                                                                maxlength="{{ $header->length }}">
                                                            @if ($header->note != '')
                                                        ...
                                                        @elseif ($header->type == 'image')
                                                            ...
                                                            <input class="form-control {{ $header->class }}"
                                                                type="file" value="{{ old($header->field) }}"
                                                        ...
                                                        @elseif ($header->type == 'date')
                                                            <input class="form-control {{ $header->class }}"
                                                                type="date" value="{{ $header->default }}"
                                                                name="{{ $header->field }}">
                                                            @if ($header->note != '')
                                                                <p class='text-secondary text-xs pt-1 px-1'>
                                                                    {{ '*) ' . $header->note }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @elseif ($header->type == 'text')
                                                            <textarea class="form-control {{ $header->class }}" name="{{ $header->field }}"
                                                                maxlength="{{ $header->length }}">{{ old($header->field) ? old($header->field) : $header->default }}</textarea>
                                                            @if ($header->note != '')
                                                                <p class='text-secondary text-xs pt-1 px-1'>
                                                                    {{ '*) ' . $header->note }}
                                                                </p>
