...
class PengajuanPinjaman extends Model
{
	...
	{
		return PengajuanPinjamanAuthHelper::filterByRole($role, $username);
	}
	...
	{
		return PengajuanPinjamanAuthHelper::getCurrentUsername($data);
	}
	...
	{
		return PengajuanPinjamanAuthHelper::getUserRole($data);
	}
	...
	{
		return PengajuanPinjamanAuthHelper::isAdminUser($data);
	}
	...
	{
		return PengajuanPinjamanValidationHelper::hasExistingPengajuan($anggotaId, $excludeId, $statuses);
	}
	...
	{
		return PengajuanPinjamanCalculationHelper::checkTopUpEligibility($anggotaId);
	}
	...
	{
		return PengajuanPinjamanCalculationHelper::determineLoanType($anggotaId);
	}
	...
	{
		return PengajuanPinjamanCalculationHelper::calculateLoanAmounts($jumlahPaket, $tenorBulan);
	}
	...
	{
		return PengajuanPinjamanCalculationHelper::getTenorBulan($tenorString);
	}
	...
	{
		return PengajuanPinjamanValidationHelper::isEditable($this->status_pengajuan);
	}
	...
	{
		return PengajuanPinjamanValidationHelper::getValidationRules();
	}
	...
	{
		return PengajuanPinjamanCalculationHelper::getStatistics($collection);
	}
	...
	{
		return PengajuanPinjamanAuthHelper::applySearchFilter($query, $search);
	}
	...
	{
		return PengajuanPinjamanAuthHelper::applyAuthorizationRules($query, $authorize, $userRoles);
	}
	...
	{
		return PengajuanPinjamanWorkflowHelper::createApprovalHistory($this, $userRole, $currentUsername);
	}
	...
	{
		return PengajuanPinjamanWorkflowHelper::createActiveLoan($this, $jumlahPaket, $tenorPinjaman, $formatHelper, $currentUsername);
	}
	...
	{
		return PengajuanPinjamanWorkflowHelper::processAfterCreation($this, $userRole, $currentUsername, $jumlahPaket, $tenorPinjaman, $formatHelper);
	}
}
