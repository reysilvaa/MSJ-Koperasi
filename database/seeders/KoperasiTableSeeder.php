    ...
    public function run(): void
    {
        ...
        $configs = [
            ...
            'KOP101' => [
                'gmenu' => 'KOP001',
                'fields' => [
                    ['field' => 'nik', 'alias' => 'NIK', 'type' => 'text', 'length' => '16', 'validate' => 'required|unique:mst_anggota,nik'],
                    ['field' => 'user_id', 'alias' => 'User', 'type' => 'enum', 'length' => '11', 'validate' => 'required|unique:mst_anggota,user_id', 'query' => "select id as value, email as name from users"],
                    ...
                    ['field' => 'no_telp', 'alias' => 'No Telp', 'type' => 'text', 'length' => '15', 'validate' => 'nullable'],
                    ...
                    ['field' => 'nama_pemilik_rekening', 'alias' => 'Nama Pemilik Rekening', 'type' => 'text', 'length' => '100', 'validate' => 'nullable'],
