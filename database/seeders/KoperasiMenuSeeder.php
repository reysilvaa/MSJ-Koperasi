...
class KoperasiMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dmenus = [
            ...
            ['gmenu' => 'KOP002', 'dmenu' => 'KOP203', 'js' => '1', 'name' => 'Data Pinjaman Aktif', 'layout' => 'manual', 'url' => 'pinjaman', 'tabel' => 'pinjaman', 'icon' => 'fas fa-money-check-alt', 'urut' => 3, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],

            // KOP003 - Pencairan (sesuai activity diagram 04)
            ['gmenu' => 'KOP003', 'dmenu' => 'KOP301', 'js' => '1', 'name' => 'Periode Pencairan', 'layout' => 'master', 'url' => 'periode-pencairan', 'tabel' => 'periode_pencairan', 'icon' => 'fas fa-calendar-alt', 'urut' => 1, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
            ...
            ['gmenu' => 'KOP004', 'dmenu' => 'KOP401', 'js' => '0', 'name' => 'Cicilan Anggota', 'layout' => 'master', 'url' => 'cicilan', 'tabel' => 'cicilan_pinjaman', 'icon' => 'fas fa-credit-card', 'urut' => 1, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
            ['gmenu' => 'KOP004', 'dmenu' => 'KOP402', 'js' => '0', 'name' => 'Iuran Anggota', 'layout' => 'master', 'url' => 'iuran', 'tabel' => 'iuran_anggota', 'icon' => 'fas fa-piggy-bank', 'urut' => 2, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
