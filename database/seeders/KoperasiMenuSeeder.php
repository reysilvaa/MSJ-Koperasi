...
class KoperasiMenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $dmenus = [
            // KOP001 - Master Data
            ['gmenu' => 'KOP001', 'dmenu' => 'KOP101', 'js' => '0', 'name' => 'Data Anggota', 'layout' => 'master', 'url' => 'users', 'tabel' => 'users', 'icon' => 'fas fa-user-friends', 'urut' => 1, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
            ...
            ['gmenu' => 'KOP005', 'dmenu' => 'KOP503', 'js' => '0', 'name' => 'Laporan Anggota', 'layout' => 'report', 'url' => 'laporan-anggota', 'tabel' => 'users', 'icon' => 'fas fa-users', 'urut' => 3, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],

            // Laporan Keuangan Sesuai Activity Diagrams 09 & 11
            ['gmenu' => 'KOP005', 'dmenu' => 'KOP504', 'js' => '0', 'name' => 'Neraca (Balance Sheet)', 'layout' => 'report', 'url' => 'laporan-neraca', 'tabel' => 'users', 'icon' => 'fas fa-balance-scale', 'urut' => 4, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
            ...
            ['gmenu' => 'KOP005', 'dmenu' => 'KOP507', 'js' => '0', 'name' => 'Laporan SHU Tahunan', 'layout' => 'report', 'url' => 'laporan-shu', 'tabel' => 'users', 'icon' => 'fas fa-trophy', 'urut' => 7, 'isactive' => '1', 'created_at' => now(), 'updated_at' => now(), 'user_create' => 'seeder', 'user_update' => 'seeder'],
